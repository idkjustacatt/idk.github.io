...
time.sleep(2)
print(Fore.LIGHTYELLOW_EX + 'https://github.com/Blagdoii/NullChecker <- Beta v4 (DOWNLOAD NOW)')
time.sleep(1)
print(Fore.LIGHTYELLOW_EX + 'Give me star and follow on Github! ⭐🚀')
time.sleep(1)
print(Fore.LIGHTYELLOW_EX + 'Official mirror ⌨️: https://github.com/Blagdoii/NullChecker')
time.sleep(1)
